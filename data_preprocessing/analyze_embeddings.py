"""
Script to analyze and explore word embeddings for financial news
"""
...
def find_optimal_clusters(embeddings, max_clusters=10):
    ...
    plt.plot(range(2, min(max_clusters + 1, len(embeddings))), silhouette_scores, marker='o')
...
def explore_financial_terms(embedder, terms=None):
    """Explore relationships between financial terms using word embeddings"""
    if terms is None:
        terms = [
...
def main():
    ...
    sample_index = 0  # Use first document as example
