"""
Text preprocessing utilities for Moroccan financial news
"""
...
class FinancialNewsPreprocessor:
    """
    Class for preprocessing financial news articles in French
    """
    ...
    def __init__(self, 
        ...
        try:
            ...
            logger.warning("French spaCy model not found. Consider installing with: python -m spacy download fr_core_news_md")
            self.nlp = None
    ...
    def preprocess_text(self, text: str) -> Dict[str, Any]:
        ...
        # Tokenize and process with spaCy if available
        if self.nlp:
    ...
    def preprocess_df(self, 
        ...
        Args:
            ...
            new_column: Column name for processed text
            tokens_column: Column name for tokens
            
        Returns:
            DataFrame with processed text and tokens columns
        """
    ...
    def _normalize_text(self, text: str) -> str:
        """
        Normalize text by removing accents, extra spaces, etc.
    ...
    def create_tfidf_vectorizer(self, **kwargs):
        """
        Create a TF-IDF vectorizer with appropriate settings for French financial text
        ...
        params = {
            ...
            'tokenizer': lambda doc: doc.split(),  # Use simple space tokenizer as text is already preprocessed
