"""
Advanced text cleaner for French financial news
Handles special financial symbols, numeric formats, company names, and more
"""
...
class FinancialTextCleaner:
    """
    Class for cleaning and normalizing French financial text
    """
    ...
    def __init__(self, 
        ...
        """
        Initialize the cleaner with configurable options
        
        Args:
            keep_numbers: Whether to keep numbers in the text
            keep_pct: Whether to keep percentage symbols and values
            keep_monetary: Whether to keep monetary symbols and values
            lowercase: Whether to convert text to lowercase
            remove_punct: Whether to remove punctuation
            remove_special_chars: Whether to remove special characters
            normalize_whitespace: Whether to normalize whitespace
            preserve_entities: Whether to preserve named entities like companies
        """
    ...
    def normalize_monetary_values(self, text: str) -> str:
        ...
        Example: '10 millions de dirhams' -> '10_MDH'
        """
    ...
    def normalize_percentages(self, text: str) -> str:
        """
        Normalize percentage values to standard format
        Example: '5 pour cent' -> '5_PCT'
        """
        if self.keep_pct:
    ...
    def normalize_accents(self, text: str) -> str:
        ...
        """
        # Unicode normalization form D (NFD) decomposes combined graphemes 
    ...
    def preserve_financial_abbreviations(self, text: str) -> str:
        """
        Preserve important financial abbreviations
        """
    ...
    def handle_apostrophes(self, text: str) -> str:
        """
        Handle apostrophes intelligently for French financial text
        """
        # First, explicitly remove common French articles with apostrophes
        # This ensures they're filtered out regardless of stopwords list
    ...
    def preserve_named_entities(self, text: str) -> str:
        """
        Preserve named entities like company names in the text
        """
