"""
Comprehensive French stopwords for financial text analysis
Combines stopwords from multiple sources and preprocesses them consistently
"""

def get_french_stopwords():
    """
    Returns a comprehensive set of French stopwords optimized for financial text analysis
    """
    # Core French stopwords (from NLTK and spaCy)
    FRENCH_STOPWORDS = {
